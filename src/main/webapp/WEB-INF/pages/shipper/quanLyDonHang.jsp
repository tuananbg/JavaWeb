...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/css/shipper/home.css' />"/>
...
<div class=" animated bounce" style="margin:20px;">
                                    ...
                                    <div class="row p-5">
                                        <div class="col-md-12">
                                            <table class="table chiTietTable"
                                                ...
                                                <tr>
                                                    <th
                                                            class="border-0 text-uppercase small font-weight-bold">STT
                                                    </th>
                                                    <th
