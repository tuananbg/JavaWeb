...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/css/admin/quanlySanPham.css' />"/>
</head>
<body>
...
<div class="col-md-10 animated bounce">
    ...
    <div class="form-group form-inline">
        <input class="form-control" type="text" id="searchById"
            ...
            class="glyphicon glyphicon-search" aria-hidden="false"
            style="left: -30px; top: 10px;"></span>
    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label for="inputPassword4">Màn hình</label> <input type="text"
                                                                                    class="form-control" name="manHinh"
                                                                                    required="required">
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                <label for="inputPassword4">Thiết kế</label> <input type="text"
                                                                                    class="form-control" name="thietKe"
                                                                                    required="required">
                            </div>
                        </div>
